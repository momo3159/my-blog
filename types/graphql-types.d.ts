...
export type Unnamed_1_Query = { allContentfulBlogPost: (
    Pick<ContentfulBlogPostConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<ContentfulBlogPost, 'id' | 'date' | 'slug' | 'title'>
      & { body?: Maybe<Pick<ContentfulBlogPostBodyTextNode, 'id' | 'body'>>, tags?: Maybe<Array<Maybe<Pick<ContentfulTag, 'tagName' | 'slug'>>>> }
    )> }
  ) };
